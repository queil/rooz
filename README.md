...
<img src="https://github.com/queil/rooz/blob/main/assets/rooz512.webp?raw=true" width="256"> Rooz is a CLI tool that enables you to work in containers. It is intended for developers and DevOps engineers. Because of that, it comes with a built-in support for git repositories, SSH keys generation, shared caches, and a robust CLI. Rooz is similar to [toolbox](https://docs.fedoraproject.org/en-US/fedora-silverblue/toolbox/)
